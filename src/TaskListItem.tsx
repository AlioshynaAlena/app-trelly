...
// import { NavLink } from "./shared/libs/router/Router";
...
console.log('Task data:', props.task)
    ...
    return <li>
        <h4><NavLink to={`/boards/${props.task.attributes.boardId}/tasks/${props.task.id}`}>{props.task.attributes.title}</NavLink></h4>
    </li>
}
